...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        ...
        resources, enabling easier management and reuse across your organization.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Symphony streamlines Kubernetes complexity, allowing you to manage resources
  ...
  },
  {
    ...
    description: (
      <>
        Symphony effortlessly scales your resource management from simple deployments
